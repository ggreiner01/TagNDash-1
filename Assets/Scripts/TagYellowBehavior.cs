...
public class TagYellowBehavior : MonoBehaviour {
    float lifespan = 1.0f;
    ...
    void OnCollisionEnter(Collision collision)
    {
        ...
        {
            Destroy(gameObject);
            collision.gameObject.GetComponent<AdultObject>().SetTagGussed("Yellow");
        ...
        {
            Destroy(gameObject);
            collision.gameObject.GetComponent<ChildObject>().SetTagGussed("Yellow");
        }
    }
}
