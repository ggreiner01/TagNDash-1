...
public class TagGreenBehavior : MonoBehaviour {
    float lifespan = 1.0f;
    ...
    void OnCollisionEnter(Collision collision)
    {
        ...
        {
            Destroy(gameObject);
            collision.gameObject.GetComponent<AdultObject>().SetTagGussed("Green");
        ...
        {
            Destroy(gameObject);
            collision.gameObject.GetComponent<ChildObject>().SetTagGussed("Green");
        }
    }
}
