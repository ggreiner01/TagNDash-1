...
public class TagBlackBehavior : MonoBehaviour {
    ...
    void OnCollisionEnter(Collision collision)
    {
        ...
        {
            Destroy(gameObject);
            collision.gameObject.GetComponent<AdultObject>().SetTagGussed("Black");
        ...
        {
            Destroy(gameObject);
            collision.gameObject.GetComponent<ChildObject>().SetTagGussed("Black");
        }
    }
}
